...
<body>
  ...
  <div class="nav-container  position-relative">
    <div class="container">
      <nav class="navbar navbar-expand-lg nav-bg navbar-light py-3 py-lg-0">
        <a href="index.html" class="navbar-brand text-secondary">
          <img src="img/choiceDev_logo.png" alt="Logo" style="filter: brightness(1.5) contrast(1.2);">
        </a>
...
<div class="banner">
    <div class="banner-video">
      <video autoplay muted loop class="w-100">
        <source src="img/AdobeStock_250452057_hero_banner.mp4" type="video/mp4" />
    ...
    <div class="container py-5">
      ...
      <div class="row align-items-center pb-5 pt-5">
        <div class="col-lg-6 mb-3 about-img">
          <img class="img-fluid mb-4 mb-lg-0" src="img/AdobeStock_281975477_about_us.jpeg" alt="" />
        </div>
        <div class="col-lg-6 about-contents">
          <h4 class="display-5 text-uppercase mb-5">
            Your Most Trusted Digital Solutions Partner in Downtown
          </h4>
          <p class="sub-text justify-text mb-3">
            ChoiceDev specializes in custom web design, development, and digital solutions tailored to your business
            needs. We combine creativity, cutting-edge technology, and strategic thinking to build fast, scalable, and
            secure platforms that drive growth. Your success is our code.
          </p>
          <p class="sub-text justify-text">
            At ChoiceDev, we don’t just build websites—we craft digital experiences that elevate your brand and engage
            your audience. From responsive designs to robust e-commerce platforms, our team delivers innovative,
            future-proof tools that align with your goals. Let us transform your vision into a high-performing online
            presence that stands out in today’s competitive landscape.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="container pb-5 pt-5">
      ...
      <div class="row  portfolio-container justify-content-center">
        ...
        <div class="col-lg-4 col-md-6 mb-4 portfolio-item first">
          <img src="img/Design project card picture.png" class="card-img-top" alt="Portfolio Item">
        ...
        <div class="col-lg-4 col-md-6 mb-4 portfolio-item second">
          <!-- Portfolio Card -->
          <img src="img/hrbritech_ltd_2.jpg" class="card-img-top" alt="Portfolio Item">

          <div class="portfolio-btn d-flex align-items-center justify-content-center">
            <a href="#" data-bs-toggle="modal" data-bs-target="#portfolioModal2">
              <i class="fa fa-4x fa-plus text-primary"></i>
            </a>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 mb-4 portfolio-item second">
          <!-- Portfolio Card -->
          <img src="img/mess-1.jpg" class="card-img-top" alt="Portfolio Item">

          <div class="portfolio-btn d-flex align-items-center justify-content-center">
            <a href="#" data-bs-toggle="modal" data-bs-target="#portfolioModal3">
              <i class="fa fa-4x fa-plus text-primary"></i>
            </a>
          </div>
        </div>
                ...
                <div id="carouselPortfolio1" class="carousel slide carousel-fade mb-4" data-bs-ride="carousel">
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                      <img src="img/Design project 1st picture.png" class="d-block w-100" alt="Project Image 1">
                    </div>
                    <div class="carousel-item">
                      <img src="img/Design Project 2nd picture.png" class="d-block w-100" alt="Project Image 2">
                    </div>
                  </div>
        ...
        <div class="modal fade" id="portfolioModal2" tabindex="-1" aria-hidden="true">
          <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <!-- Image Carousel -->
                <div id="carouselPortfolio2" class="carousel slide carousel-fade mb-4" data-bs-ride="carousel">
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                      <img src="img/hybritech 33.jpg" class="d-block w-100" alt="Project Image 1">
                    </div>
                    <div class="carousel-item">
                      <img src="img/hybritech_11.jpg " class="d-block w-100" alt="Project Image 2">
                    </div>
                  </div>
                  <button class="carousel-control-prev" type="button" data-bs-target="#carouselPortfolio2"
                    data-bs-slide="prev">
                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                    <span class="visually-hidden">Previous</span>
                  </button>
                  <button class="carousel-control-next" type="button" data-bs-target="#carouselPortfolio2"
                    data-bs-slide="next">
                    <span class="carousel-control-next-icon" aria-hidden="true"></span>
                    <span class="visually-hidden">Next</span>
                  </button>
                ...
                <!-- Content Section -->
                <div class="portfolio-content">
                  <h5 class="text-black">Hybritech CMS</h5>

                  <p>Hybritech CMS is a custom-built content management system developed by ChoiceDev, designed for high-performance web applications. Built using a modern tech stack, it features a modular architecture, API-first design, role-based access control, and seamless third-party integrations—delivering scalable, secure, and flexible content management for Hybritech Innovations Ltd.</p>
                  <ul class="list-inline">
                    <li class=""><strong>Client:</strong> Hybritech Innovations Ltd</li>
                    <li class=""><strong>Category:</strong> Development</li>
                    <li class=""><strong>Date:</strong> December 2024</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div id="carouselPortfolio3" class="carousel slide carousel-fade mb-4" data-bs-ride="carousel">
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                      <img src="img/mess-2.jpg" class="d-block w-100" alt="Project Image 1">
                    </div>
                    <div class="carousel-item">
                      <img src="img/mess-3.jpg" class="d-block w-100" alt="Project Image 2">
                    </div>
                    <div class="carousel-item">
                      <img src="img/mess-4.jpg" class="d-block w-100" alt="Project Image 2">
                    </div>
                  </div>
    ...
    <div class="container py-3">
      ...
      <div class="row align-items-center pb-5">
        <div class="col-lg-6 choose-img">
          <img class="img-fluid mb-4 mb-lg-0" src="img/AdobeStock_213205204_aboutuss.jpeg" alt="" />
        </div>
    ...
    <div class="container free-quote-section py-3">
      <div class="row align-items-center pt-5 pb-5">
        <div class="col-lg-6 free-quote-img">
          <img class="img-fluid mb-4 mb-lg-0" src="img/Free Quote WB.png" alt="free quote" />
        ...
        <div class="col-lg-6 choose-contents pt-5">
          ...
          <div class="btn-free-qoute pt-5">
            <a href="contact.html" class="btn btn-qoute text-uppercase mt-1 py-3 px-5">Request a Free Quote</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <!-- Footer Start -->
  <footer>
    <div class="container-fluid py-4 px-sm-3 px-md-5" style="background: #0f0f0f" pt-5>
      <div class="container">
        <div class="row pt-5 footer-top-row">
          ...
          <div class="col-md-4 footer-desc-col">
            <p class="text-light justify-text" style="margin-bottom: 40px; font-size: 15px">
              ChoiceDev blends advanced AI development with intuitive UX
              design to deliver digital products that elevate brand value and
              customer experience.
            </p>
            <a href="contact.html" class="btn-footer-contact text-uppercase py-3 px-4">
              Contact Us
            </a>
          </div>
          <div class="col-md-5 contact-info footer-contact-col">
            ...
            <div class="contact-item">
              ...
              <h6>Suite 11/41/45 Rickard Rd, Bankstown NSW 2200</h6>
            </div>
            <div class="contact-item">
              <i class="fa-solid fa-envelope"></i>
              <h6>info@choicedev.com.au</h6>
            </div>
          </div>
        </div>
        <div class="row footer-social-row">
          <div class="col-md-4 offset-md-3">
            <div class="footer-botton-social-icon pt-3">
              <ul>
                <li>
                  <a href="https://www.facebook.com/profile.php?id=61576885797545" target="_blank">
                    <i class="fa-brands fa-facebook-f"></i>
                  </a>
                </li>
                <li>
                  <a href="https://www.linkedin.com/company/choicedev1" target="_blank">
        ...
        <div class="row footer-nav-row">
          <div class="col-md-9 offset-md-3">
            <div class="footer-nav pt-2" style="display: flex; flex-direction: row; gap: 50px">
  ...
  <!-- Back to Top -->
  <a href="#" class="btn btn-lg btn-footer btn-lg-square back-to-top"><i class="fa fa-angle-up"></i></a>
